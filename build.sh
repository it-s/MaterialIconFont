...
do
    cp $SRC_DIR/$MODULE/$PRODUCTION_DIR/$PATTERN $TEMP_DIR
done
...
fontcustom.ruby2.1 compile -c $BASE_DIR/MaterialIconsFont.yml
mv $BUILD_DIR/MaterialIcons.ttf $BUILD_DIR/MaterialIcons_raw.ttf
ttfautohint -v -D none -s -l 4 -G 0 -f hebr $BUILD_DIR/MaterialIcons_raw.ttf $BUILD_DIR/MaterialIcons.ttf
